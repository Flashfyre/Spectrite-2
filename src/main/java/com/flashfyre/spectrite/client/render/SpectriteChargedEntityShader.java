...
public class SpectriteChargedEntityShader extends SpectriteChargedShader
{
    private static final Identifier spectriteChargedEntityId = Spectrite.getId("shaders/post/spectrite_charged_entity.json");
    public static final ManagedShaderEffect EFFECT = ShaderEffectManager.getInstance()
            .manage(spectriteChargedEntityId, SpectriteChargedEntityShader::assignDepthTexture);
    ...
    public static final RenderLayerSupplier SUPPLIER = RenderLayerSupplier.framebuffer(
            ...
            SpectriteChargedEntityShader::beginFbWrite,
            SpectriteChargedEntityShader::performFbCleanup
    );
    public static final Uniform1f STIME = EFFECT.findUniform1f("STime");

    public SpectriteChargedEntityShader(String name, VertexFormat vertexFormat, VertexFormat.DrawMode drawMode, int expectedBufferSize,
